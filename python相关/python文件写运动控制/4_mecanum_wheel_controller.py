...
DEFAULT_HALF_DIPAN_LENGTH = 1.0
DEFAULT_HALF_DIPAN_WIDTH = 1.0
DEFAULT_WHEEL_RADIUS = 1.0
...
class CmdVelTransfer():
    ...
    def __init__(self):
        ...
        self.a = DEFAULT_HALF_DIPAN_LENGTH
        self.b = DEFAULT_HALF_DIPAN_WIDTH
        self.r = DEFAULT_WHEEL_RADIUS

        ### Publish to the specific wheel's topic ###
        self.pub_fr_motor = rospy.Publisher(TOPIC_FR_CMD, Float32,queue_size=10)
        self.pub_fl_motor = rospy.Publisher(TOPIC_FL_CMD, Float32,queue_size=10)
        self.pub_rl_motor = rospy.Publisher(TOPIC_RL_CMD, Float32,queue_size=10)
        self.pub_rr_motor = rospy.Publisher(TOPIC_RR_CMD, Float32,queue_size=10)
